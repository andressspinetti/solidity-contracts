...
contract SmartContractWallet {
    ...
    function proposeNewOwner(address payable _newOwner) public {
        require(guardians[msg.sender], "You are not a guarding of this wallet, aborting.");
        require(nextOwnerGuardianVotedBool[_newOwner][msg.sender], "You already voted, aborting.");
